...
if(pathname==='/cart')setActiveItem('Cart')
if(pathname==='/wishlist')setActiveItem('wishlist')
if(pathname==='/login')setActiveItem('Login')
if(pathname==='history')setActiveItem('History')
},[])
return (
...
{/**Navbar */}
      ...
      <div className='space-x-4 text-red-600 hover:text-amber-300 hover:underline justify-evenly'>
        ...
        <NavItem activeItem={activeItem} setActiveItem={setActiveItem} name={'Cart'} route={'/cart'}></NavItem>
        <NavItem activeItem={activeItem} setActiveItem={setActiveItem} name={'Wishlist'} route={'/wishlist'}></NavItem>
        <NavItem activeItem={activeItem} setActiveItem={setActiveItem} name={'Login'} route={'/login'}></NavItem>
        <NavItem activeItem={activeItem} setActiveItem={setActiveItem} name={'History'} route={'/history'}></NavItem>
